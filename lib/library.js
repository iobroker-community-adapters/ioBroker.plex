	...
	async extendState(state) {
		...
		if (state.indexOf('._Controls.') !== -1) {
			...
			if (this._actions[appendix[0]] && this._actions[appendix[0]][appendix[1]] && this._actions[appendix[0]][appendix[1]].type) {
				node = {"type": this._actions[appendix[0]][appendix[1]].type, "role": this._actions[appendix[0]][appendix[1]].role, "description": this._actions[appendix[0]][appendix[1]].description}
			}
		} else {
			// _NODES
