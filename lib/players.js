...
class Controller {
     ...
     * Constructor.
     *
     * @param	adapter		ioBroker adapter object
     * @param    library     Library object
     * @param    options Json with config
     */
...
class Player {
    ...
    /**
     *
     * @param actionVal.mode 			mode see _ACTIONS (4. dp)
     * @param actionVal.action 		action "    " (5. dp)
     * @param actionVal.val 				val value of action
     * @param actionVal.id 			dp of state (1.+2.+3. dp)
     * @param actionVal
     */
