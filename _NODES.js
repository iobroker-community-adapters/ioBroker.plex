module.exports =
{
	...
	"events.thumb": {"description": "Address of server ", "role": "media.cover", "type": "string"},
	...
	"playing.metadata.grandparentart": {"description": "", "role": "text", "type": "string", "convert":{"func":"create-link", "type":"string", "role":"media.cover.big","key":"_link"}},
	"playing.metadata.grandparentart_link": {"description": "", "role": "media.cover.big", "type": "string", "convert":{"func":"create-link", "type":"string", "role":"media.cover.big","key":"_link"}},
	...
	"playing.metadata.grandparentthumb": {"description": "", "role": "text", "type": "string", "convert":{"func":"create-link", "type":"string", "role":"media.cover.small","key":"_link"}},
	"playing.metadata.grandparentthumb_link": {"description": "", "role": "media.cover.small", "type": "string", "convert":{"func":"create-link", "type":"string", "role":"media.cover.small","key":"_link"}},
	...
	"playing.metadata.parentthumb": {"description": "Parent thumb (e.g of season or album)", "role": "text", "type": "string", "convert":{"func":"create-link", "type":"string", "role":"media.cover.small","key":"_link"}},
	"playing.metadata.parentthumb_link": {"description": "Parent thumb (e.g of season or album)", "role": "media.cover.small", "type": "string", "convert":{"func":"create-link", "type":"string", "role":"media.cover.small","key":"_link"}},
	...
	"playing.metadata.lastviewedat": {"description": "Timestamp of last watched time", "role": "date", "type": "number", "convert": {"func":"date-timestamp","key":"date","role":"text", "type":"string"}},
	"playing.metadata.updatedat": {"description": "Timestamp of last updated time", "role": "date", "type": "number", "convert": {"func":"date-timestamp","key":"date","role":"text", "type":"string"}},
	"playing.metadata.addedat": {"description": "Timestamp of add media to database", "role": "date", "type": "number", "convert": {"func":"date-timestamp","key":"date","role":"text", "type":"string"}},
	...
	"playing.metadata.duration": {"description": "The duration (in minutes) for the item", "role": "value", "type": "number", "convert": {"func":"ms-min"}},
	"playing.metadata.art": {"description": "The artwork of the item", "role": "text", "type": "string", "convert":{"func":"create-link", "type":"string", "role":"media.cover.big","key":"_link"}},
	"playing.metadata.art_link": {"description": "The artwork of the item", "role": "media.cover.big", "type": "string", "convert":{"func":"create-link", "type":"string", "role":"media.cover.big","key":"_link"}},
	...
	"playing.metadata.genre": {"description": "Genres as a list", "role": "media.genre", "type": "string"},
	...
	"playing.metadata.thumb": {"description": "The thumbnail of the item", "role": "text", "type": "string", "convert":{"func":"create-link", "type":"string", "role":"media.cover.small","key":"_link"}},
	"playing.metadata.thumb_link": {"description": "The thumbnail of the item", "role": "media.cover.small", "type": "string", "convert":{"func":"create-link", "type":"string", "role":"media.cover.small","key":"_link"}},
	...
	"playing.metadata.viewoffsethumanseconds": {"description": "Last viewing position in seconds(refresh)", "role": "media.elapsed", "type": "number", "convert": {"func":"seconds-readable"}},
	...
	"playlists.lastviewedat": {"description": "Timestamp of last watched time", "role": "value", "type": "number", "convert": {"func":"date-timestamp","key":"date","role":"text", "type":"string"}},
	"playlists.updatedat": {"description": "Timestamp of last watched time", "role": "value", "type": "number", "convert": {"func":"date-timestamp","key":"date","role":"text", "type":"string"}},
	"playlists.addedat": {"description": "Timestamp of last watched time", "role": "value", "type": "number", "convert": {"func":"date-timestamp","key":"date","role":"text", "type":"string"}},
	"playlists.addedatdate": {"description": "Date of add media to database", "role": "value", "type": "string", "convert": {"func":"date-timestamp","key":"date","role":"text", "type":"string"}},
	"playlists.lastviewedatdate": {"description": "add media at date", "role": "value", "type": "string", "convert": {"func":"date-timestamp","key":"date","role":"text", "type":"string"}},
	"playlists.updatedatdate": {"description": "Date of last viewed time", "role": "value", "type": "string", "convert": {"func":"date-timestamp","key":"date","role":"text", "type":"string"}},
	...
	"playlists.composite": {"description": "Artwork of the Playlist", "role": "text", "type": "string", "convert":{"func":"create-link", "type":"string", "role":"media.cover","key":"_link"}},
	"playlists.composite_link": {"description": "Artwork of the Playlist", "role": "media.cover", "type": "string", "convert":{"func":"create-link", "type":"string", "role":"media.cover","key":"_link"}},
	...
	"playlists.duration": {"description": "Total duration (in minutes) for the Playlist", "role": "value", "type": "number", "convert": {"func":"ms-min"}},
